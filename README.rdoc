...
* Optionally defina a +crud_attrs+ class variable that is an array or block that returns an array of modde field names in your controller to limit what is crud'able.
